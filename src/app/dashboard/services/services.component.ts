...
export class ServicesComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, public _SerService: ServicesService,
    private localStorage: LocalstorageService, private _catServ: CategoriesService) { }
  ...
  submitNewService(f) {
    ...
    new_sfd.append('company', this.localStorage.get('id'));
  ...
  submitNewCat(f) {
    ...
    new_cfd.append('company', this.localStorage.get('id'));
